...
% This example shows how to use a custom kernel function, such as the
% sigmoid kernel, to train SVM classifiers, and adjust custom kernel
% function parameters.
%%
% Generate a random set of points within the unit circle. Label points in
% the first and third quadrants as belonging to the positive class, and
% those in the second and fourth quadrants in the negative class.
...
misclass2
%%
% After the sigmoid slope adjustment, the new decision boundary seems to
% provide a better within-sample fit, and the cross-validation rate
% contracts by more than 66%.
